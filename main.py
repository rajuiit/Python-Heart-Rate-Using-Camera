...
camPen = pg.mkPen(width=1, color='g')
#psPen = pg.mkPen(width=3, color='y')
win.setWindowTitle('Heart Beat Measurement for detecting liveliness')
# end Qt Setup
...
def setup_csv(csvStr=None):
    ...
    headers = (
                 u'cam_time' + ',' + u'cam_waveform' + ',' + u'cam_bpm')
...
def update():
   ...
   # else:
    ...
    #print("cam:"+str(np.median(camBPMData)))
    #print(psTime[-1], t[-1])
